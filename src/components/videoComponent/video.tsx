...
function Video( {video}: any){
    ...
    function TransformViews() {
        ...
        // Verifica se 'video' e 'video.statistics' estão definidos antes de tentar acessar 'viewCount'
        if (video && video.statistics && video.statistics.viewCount) {
        ...
        // Retorna uma mensagem padrão se 'viewCount' não estiver disponível
        return 'Visualizações indisponíveis';
    }
        ...
        <Container styles={menu} searchStyle={videosSearch}>
            ...
            <PerfilTitleContainer styles={menu}>
                ...
                <TitleContainer>
                    ...
                    <Views>{video.snippet.channelTitle}</Views>
