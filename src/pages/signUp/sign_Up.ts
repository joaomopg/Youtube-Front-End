...
`
export const InputsContainerPassword = styled.div`
    width: 100%;
    height: auto;
    margin-top: 20px;
    display: flex;
...
`
export const InputsName = styled.input<{textName: boolean}>`
    width: 100%;
    height: 50px;
    border: ${({textName})=> textName? '2px solid red' : '1px solid #d9d9d9'};
    padding: 4px 12px;
    box-sizing: border-box;
    border-radius: 6px;
    font-size: 18px;
